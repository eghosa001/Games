...
9. Desktop and mobile are different compositions, not merely scaled copies. Phone layouts favor bottom-reachable primary navigation, fewer simultaneous controls, and 44 px or larger touch targets.
