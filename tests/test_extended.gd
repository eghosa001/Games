...
func run() -> void:
    ...
    if s != null:
        ...
        for n in ["Economy","Production","Districts","RestorationStrategy","Expansion","RegionController","Corporate","SupplyChainController","WorldMissions","MarketDirector","MobileUI"]: check(g.get_node_or_null(n) != null, "Controller " + n)
