...
func _layout() -> void:
    ...
    title_label.text = "COMMERCIAL CONTRACTS" if phone else "CONTRACTS & COMMERCIAL DEALS"
    ...
    status_label.position = Vector2(14, 40)
