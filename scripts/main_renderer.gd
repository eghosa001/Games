...
func _draw() -> void:
    ...
    draw_string(font, Vector2(270, 39), "CASH $%s" % main._money(main.cash), HORIZONTAL_ALIGNMENT_LEFT, -1, 18, Color("8ee6a8"))
    draw_string(font, Vector2(500, 39), "REP %d" % main.reputation, HORIZONTAL_ALIGNMENT_LEFT, -1, 18, Color("f2d27a"))
    draw_string(font, Vector2(620, 39), "DEBT $%s" % main._money(main.debt), HORIZONTAL_ALIGNMENT_LEFT, -1, 18, Color("ffad8f"))
    draw_string(font, Vector2(790, 39), "PROFIT $%s" % main._money(main.total_profit), HORIZONTAL_ALIGNMENT_LEFT, -1, 18, Color("b7d7ff"))
    ...
    draw_string(font, Vector2(45, 258), "Next stage: $%s" % main._money(main._next_cost()), HORIZONTAL_ALIGNMENT_LEFT, -1, 15, Color("f2d27a"))
    ...
    draw_string(font, Vector2(455, 303), "Contract: %d days | $%s/day" % [main.contract_days, main._money(main.contract_bonus)], HORIZONTAL_ALIGNMENT_LEFT, -1, 14, Color("f2d27a"))
    draw_string(font, Vector2(455, 326), "Last P&L: $%s" % main._money(main.last_profit), HORIZONTAL_ALIGNMENT_LEFT, -1, 14, Color.WHITE)
    ...
    draw_string(font, Vector2(45, 457), "Supplier tier %d | Debt payment $%s/day" % [main.supplier_choice + 1, main._money(main.loan_payment)], HORIZONTAL_ALIGNMENT_LEFT, -1, 14, Color("b7d7ff"))
