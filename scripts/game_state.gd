...
const DOMAINS := ["player","company","properties","businesses","branches","employees","economy","resources","production","supply_chain","contracts","competitors","ownership","finance","alliances","diplomacy","regions","infrastructure","technology","management","events","progression","history","news","analytics","acquisition","bankruptcy"]
const DOMAIN_KEYS := {"player":["day","reputation"],"company":["message","log_lines","culture","reputation"],"properties":["owned","inspected","restoration","stage","selected_property","catalog","cleaning","repair","painting","furnishing"],"businesses":["business_open","business_id","business_name","business_type","business_purpose","industry_id","origin_property_id","origin_property_name","origin_property_type","capacity_level","marketing_level","player_price"],"branches":["selected_expansion","expansion"],"employees":["roster","employee_system"],"economy":["cash","last_sales","last_profit","total_profit"],"resources":["resources"],"production":["finished_goods","system"],"supply_chain":["supplier_choice","transport_level","transport_capacity","resource_sites","transport_cost_multiplier","resource_delivery_multiplier"],"contracts":["contract_days","contract_bonus","contract_system","system"],"competitors":["rivals","selected_rival","relationship","reaction_system"],"ownership":["acquisition_count","valuation","takeover_wins","system","pending_offer","holdings"],"finance":["debt","loan_payment","system"],"alliances":["alliances"],"diplomacy":["diplomacy"],"regions":["selected_district","districts","regional_reputation"],"infrastructure":["management_level","management_overhead"],"technology":["technology","research_points"],"management":["procurement_policy","pricing_policy","maintenance_policy","cash_reserve"],"events":["history","active","modifiers","seasonal","market_director"],"progression":["milestones","unlocks","xp","level","claimed_goals","tutorial_step","tutorial_completed","tutorial_dismissed"],"history":["history_system"],"news":["news_system"],"analytics":["simulation_system","real_time"],"acquisition":["system"],"bankruptcy":["system"]}
const DEFAULT_DOMAINS := {"player":{"day":1,"reputation":0},"company":{"message":"Inspect the abandoned warehouse. Your empire starts here.","log_lines":[],"culture":{},"reputation":{}},"properties":{"owned":false,"inspected":false,"restoration":0,"stage":"Neglected","selected_property":0,"catalog":[],"cleaning":0,"repair":0,"painting":0,"furnishing":0},"businesses":{"business_open":false,"business_id":"","business_name":"","business_type":"","business_purpose":"","industry_id":"","origin_property_id":"","origin_property_name":"","origin_property_type":"","capacity_level":1,"marketing_level":0,"player_price":110},"branches":{"selected_expansion":0,"expansion":{}},"employees":{"roster":[],"employee_system":{}},"economy":{"cash":35000,"last_sales":0,"last_profit":0,"total_profit":0},"resources":{"resources":{}},"production":{"finished_goods":0,"system":{}},"supply_chain":{"supplier_choice":0,"transport_level":1,"transport_capacity":40,"resource_sites":{},"transport_cost_multiplier":1.0,"resource_delivery_multiplier":1.0},"contracts":{"contract_days":0,"contract_bonus":0,"contract_system":{},"system":{}},"competitors":{"rivals":[],"selected_rival":0,"relationship":15,"reaction_system":{}},"ownership":{"acquisition_count":0,"valuation":25000,"takeover_wins":0,"system":{},"pending_offer":{},"holdings":[]},"finance":{"debt":0,"loan_payment":0,"system":{}},"alliances":{"alliances":{}},"diplomacy":{"diplomacy":{}},"regions":{"selected_district":0,"districts":{"renew_region":{"id":"renew_region","name":"Renew Region","cities":[],"resource_locations":[]}},"regional_reputation":0},"infrastructure":{"management_level":0,"management_overhead":0},"technology":{"technology":{},"research_points":20},"management":{"procurement_policy":"manual","pricing_policy":"manual","maintenance_policy":"manual","cash_reserve":7500},"events":{"history":[],"active":{},"modifiers":{},"seasonal":{},"market_director":{}},"progression":{"milestones":[],"unlocks":[],"xp":0,"level":1,"claimed_goals":{},"tutorial_step":0,"tutorial_completed":false,"tutorial_dismissed":false},"history":{"history_system":{}},"news":{"news_system":{}},"analytics":{"simulation_system":{},"real_time":{}},"acquisition":{"system":{}},"bankruptcy":{"system":{}}}
