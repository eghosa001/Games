...
func _layout() -> void:
    ...
    title_label.position = Vector2(14,10); title_label.size = Vector2(width-112,30)
    close_button.position = Vector2(width-96,7); close_button.size = Vector2(84,46)
    scroll.position = Vector2(12,58); scroll.size = Vector2(width-24,height-70)
